...
$select_user = mysqli_query($con,"SELECT * FROM wallet_history WHERE date  = '$date' AND (remark LIKE '%Withdraw%' OR remark LIKE '%Transferred to your Account%')");
    ...
    <div class="col-12">
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<h4 class="card-title">Withdraw List
					</h4>
					
					<div class="form-group">
					    <?php $sum = mysqli_fetch_array(mysqli_query($con,"SELECT SUM(amount) as sum FROM wallet_history WHERE date  = '$date' AND (remark LIKE '%Withdraw%' OR remark LIKE '%Transferred to your Account%')"))?>
								    									<badge class="badge badge-success">Total Transfer Amount is <h3>₹ <?php echo $sum['sum'];?></h3></badge>
					</div>
